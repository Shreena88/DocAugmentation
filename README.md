...
![alt text](<WhatsApp Image 2026-01-05 at 3.42.22 PM.jpeg>)
*Left: Original skewed document with detection outline | Right: Processed and rectified document*

## Download

### 📥 Ready-to-Use Application
**[Download DocAUG.exe](https://github.com/Shreena88/DocAUG/releases/latest/download/DocAUG(1).exe)** - Click to download the latest version
...
1. **[Download DocAUG.exe](https://github.com/Shreena88/DocAUG/releases/latest/download/DocAUG.exe)** ⬇️
...
**[📥 Download DocAUG.exe](https://github.com/Shreena88/DocAUG/releases/latest/download/DocAUG.exe)**
...
3. Double-click `DocAUG.exe` to launch the application
...
├── DocAUG.exe           # Standalone executable
├── src/
